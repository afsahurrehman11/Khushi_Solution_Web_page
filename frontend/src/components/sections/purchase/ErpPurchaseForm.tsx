...
import { ArrowLeft, ArrowRight, UserCircle, Building2, Upload, Check, ImageIcon, ChevronRight } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-6 pb-5 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">Fill in institutional details</p>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            {currentStep === 0 && (
              <motion.div key="step0" variants={containerVariants} initial="hidden" animate="visible" exit="exit" className="space-y-4">
                <div className="mb-4">
                  <h4 className="text-base font-bold text-slate-900">Contact Person Details</h4>
                  <p className="text-xs text-slate-500">Representative or principal information.</p>
                </div>
            ...
            {currentStep === 1 && (
              <motion.div key="step1" variants={containerVariants} initial="hidden" animate="visible" exit="exit" className="space-y-4">
                <div className="mb-4">
                  <h4 className="text-base font-bold text-slate-900">Institution Information</h4>
                  <p className="text-xs text-slate-500">Key details about your campus or school.</p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1.5">Institution Phone *</label>
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:col-span-2">
                    <div>
                      <label className="block text-xs font-semibold text-slate-700 mb-1.5">Total Students</label>
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-700 mb-1.5">Total Staff</label>
            ...
            {currentStep === 2 && (
              <motion.div key="step2" variants={containerVariants} initial="hidden" animate="visible" exit="exit" className="space-y-4">
                <div className="mb-4">
                  <h4 className="text-base font-bold text-slate-900">Institution Images</h4>
                  <p className="text-xs text-slate-500">Upload optional photos of your campus or logo.</p>
                </div>

                <div>
                  <div className="p-6 border border-slate-200 rounded-xl bg-slate-50/50 flex flex-col items-center justify-center text-center">
                    <ImageIcon className="w-8 h-8 text-slate-400 mb-2" />
                    <span className="text-xs font-bold text-slate-800 mb-1">Campus / Building Images</span>
                    <span className="text-[11px] text-slate-400 mb-4">PNG, JPG up to 5MB each</span>
                    <label className="cursor-pointer px-4 py-2 rounded-lg bg-white border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm">
